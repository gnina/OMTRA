## Computes New Atom Features for Pharmit Ligands
...
The script `run_phase2.py` is used to create compute the new atom features and write these to the empty Zarr array created by `phase1.py`.

The script gets the DGL graphs of Pharmit ligands using the PharmitDataset class and computes new atom features:
